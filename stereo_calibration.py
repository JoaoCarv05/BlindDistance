...
cv_file = cv2.FileStorage("stereo_calibration_data.xml", cv2.FILE_STORAGE_WRITE)


cv_file.write("image_width", imgL_gray.shape[1])
cv_file.write("image_height", imgL_gray.shape[0])


cv_file.write("map1x", Left_Stereo_Map[0])
cv_file.write("map1y", Left_Stereo_Map[1])
cv_file.write("map2x", Right_Stereo_Map[0])
cv_file.write("map2y", Right_Stereo_Map[1])
