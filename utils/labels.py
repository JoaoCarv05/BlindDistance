"""COCO class names translated to Brazilian Portuguese for spoken feedback."""
...
def to_pt(class_name):
    """Return the Portuguese name for a COCO class, or the original name."""
    return CLASS_NAMES_PT.get(class_name, class_name)
